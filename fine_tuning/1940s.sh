...
python RCI.py --cfg ./config/1000_dirty.json
...
python inference_base.py \
    ...
    --output_csv /work/jaaydin/outputs/1000_mccray_dirty_base_Llama_8b/results/factoid_qa_10.csv \
    --temperature 1.0 \
    --num_samples 5 \
...
python inference_base.py \
    ...
    --output_csv /work/jaaydin/outputs/1000_mccray_dirty_base_Llama_8b/results/nathan_qa.csv \
    --temperature 1.0 \
    --num_samples 5 \
    --system_prompt "You are a helpful assistant. Answer clearly and concisely. Do not ramble."