...
#SBATCH --output inference_base_%j.out
#SBATCH --error inference_base_%j.err
...
python inference_base.py \
    --model_dir /work/jaaydn/outputs/100_mccray_dirty_base_Llama_8b/model \
    --input_csv /work/jaaydin/data/factoid_qa.csv \
    --output_csv /work/jaaydin/outputs/100_mccray_dirty_base_Llama_8b/results/factoid_qa.csv \
    --temperature 1.0 \
    --num_samples 5
